...
const Navbar = () => {
  ...
  return (
      ...
      <div className=" bg-black text-gray-400 h-[100px] max-w-[1200px] mx-auto flex justify-between items-center">
        <h1 className='text-3xl font-bold primary-color ml-4'>M. MESI</h1>
        <ul className='hidden md:flex'>
          ...
          <li className='p-5'><a href='#contact'>Contact</a></li>
           ...
           <div className={ nav ? 'fixed h-full left-0 top-0 w-[60%] bg-[#0c1e1e] ease-in-out duration-500' : 'fixed left-[-100%]'}>
             <h1 className='text-3xl font-bold primary-color ml-4'>M. MESI</h1>
